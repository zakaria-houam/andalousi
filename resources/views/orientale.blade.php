...
<div class="filtre-container">
  ...
  <div class="accordion-item">
    ...
    <label><input type="checkbox" name="marque[]" value="ASQ">ASQ</label><br>
  <label><input type="checkbox" name="marque[]" value="Ibrahimalqurashi">Ibrahimalqurashi</label><br>
  <label><input type="checkbox" name="marque[]" value="Arabian Oud">Arabian Oud</label><br>
  <label><input type="checkbox" name="marque[]" value="Al-Dakheel Oud">Al-Dakheel Oud</label><br>
  <label><input type="checkbox" name="marque[]" value="Al-Madjed Oud">Al-Madjed Oud</label><br>
  <label><input type="checkbox" name="marque[]" value="Rasasi">Rasasi</label><br>
  <label><input type="checkbox" name="marque[]" value="Afnan">Afnan</label><br>
  <label><input type="checkbox" name="marque[]" value="Armaf">Armaf</label><br>
  <label><input type="checkbox" name="marque[]" value="Lattafa">Lattafa</label><br>
  <label><input type="checkbox" name="marque[]" value="Fragranceworld">Fragranceworld</label><br>
  <label><input type="checkbox" name="marque[]" value="L'orientale Fragrances">L'orientale Fragrances</label><br>
          </div>
    </div>
  </div>
